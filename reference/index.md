...
- [`create_genomic_file_batch_ids()`](https://comp-med.github.io/r-ofhelper/reference/create_genomic_file_batch_ids.md)
  : Create batch ID string for genomic files
- [`create_genomic_file_prefix()`](https://comp-med.github.io/r-ofhelper/reference/create_genomic_file_prefix.md)
  : Create genomic file prefix
- [`create_imputed_file_prefix()`](https://comp-med.github.io/r-ofhelper/reference/create_imputed_file_prefix.md)
...
- [`create_sample_file_names()`](https://comp-med.github.io/r-ofhelper/reference/create_sample_file_names.md)
  : Create OFH imputed genomic file BGEN Sample file names
- [`create_snv_file_prefix()`](https://comp-med.github.io/r-ofhelper/reference/create_snv_file_prefix.md)
...
- [`decompress_gzip()`](https://comp-med.github.io/r-ofhelper/reference/decompress_gzip.md)
...
- [`remove_tre_proxy_env_var()`](https://comp-med.github.io/r-ofhelper/reference/remove_tre_proxy_env_var.md)
